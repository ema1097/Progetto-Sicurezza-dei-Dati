import { FullValidationSchema, ShortValidationSchema, ValidationSchemaInput, ValidInputTypes } from 'web3-validator/lib/commonjs/types.js';
...
export declare const abiSchemaToJsonSchema: (abis: ShortValidationSchema | FullValidationSchema, level?: string) => import("web3-validator/lib/commonjs/types.js").Schema;
export declare const ethAbiToJsonSchema: (abis: ValidationSchemaInput) => import("web3-validator/lib/commonjs/types.js").Schema;
